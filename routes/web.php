...
$router->add('user/dashboard', ['controller' => \App\Controllers\UsersController::class, 'action' => 'index', 'method' => 'GET']);
...
$router->add('categories', ['controller' => \App\Controllers\CategoriesController::class, 'action' => 'index', 'method' => 'GET']);
